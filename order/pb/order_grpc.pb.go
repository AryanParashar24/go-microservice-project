...
const (
	OrderService_PostOrder_FullMethodName           = "/go.OrderService/PostOrder"
	OrderService_GetOrder_FullMethodName            = "/go.OrderService/GetOrder"
	OrderService_GetOrdersForAccount_FullMethodName = "/go.OrderService/GetOrdersForAccount"
)
...
type OrderServiceClient interface {
	...
	GetOrdersForAccount(ctx context.Context, in *GetOrdersAccountRequest, opts ...grpc.CallOption) (*GetOrdersAccountResponse, error)
}
...
func (c *orderServiceClient) GetOrdersForAccount(ctx context.Context, in *GetOrdersAccountRequest, opts ...grpc.CallOption) (*GetOrdersAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrdersAccountResponse)
...
type OrderServiceServer interface {
	...
	GetOrdersForAccount(context.Context, *GetOrdersAccountRequest) (*GetOrdersAccountResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrdersForAccount(context.Context, *GetOrdersAccountRequest) (*GetOrdersAccountResponse, error) {
...
func _OrderService_GetOrdersForAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrdersAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrdersForAccount(ctx, req.(*GetOrdersAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
